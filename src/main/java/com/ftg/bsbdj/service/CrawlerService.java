package com.ftg.bsbdj.service;

import com.ftg.bsbdj.common.OgnlUtils;
import com.ftg.bsbdj.entity.*;
import com.ftg.bsbdj.mapper.*;
...
public class CrawlerService {
    ...
    public void etl() {
        ...
        for (Source source : sources) {
            ...
            //将字符串转换为Map对象
            Map<String, Object> root = new Gson().fromJson(json, new TypeToken<Map>() {
            }.getType());
            //获取每页20条数据的集合
...
//                }
    ...
    public Page<Map> findContents(Integer page, Integer rows, Integer channelId, String contentType, String keyword) {
        ...
        if (keyword != null && !keyword.trim().equals("-1")) {
